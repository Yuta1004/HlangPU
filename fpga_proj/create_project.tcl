...
#
# create_project.tcl: Tcl script for re-creating project 'HlangPU'
#
# Generated by Vivado on Fri Jun 23 06:12:44 JST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../../../[file normalize "$origin_dir/HlangPU.ip/hlangpu_1_0"]"]"\
 "[file normalize "$origin_dir/../../../../../[file normalize "$origin_dir/HlangPU.ip/core_controller_1.0"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/HlangPU.ip/hlangpu_1_0"] [file normalize "$origin_dir/HlangPU.ip/core_controller_1.0"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:core_controller:1.0\
  user.org:user:hlangpu:1.0\
  ...
  # Create instance: core_controller_0, and set properties
  set core_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:core_controller:1.0 core_controller_0 ]

  # Create instance: hlangpu_0, and set properties
  set hlangpu_0 [ create_bd_cell -type ip -vlnv user.org:user:hlangpu:1.0 hlangpu_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins hlangpu_0/M_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins core_controller_0/S_AXI]
  ...
  connect_bd_net -net core_controller_0_CEXEC [get_bd_pins core_controller_0/CEXEC] [get_bd_pins hlangpu_0/CEXEC] [get_bd_pins hlangpu_0/CMEM_ADDR]
  connect_bd_net -net core_controller_0_CRST [get_bd_pins core_controller_0/CRST] [get_bd_pins hlangpu_0/CRST]
  connect_bd_net -net hlangpu_0_CSTAT [get_bd_pins core_controller_0/CSTAT] [get_bd_pins hlangpu_0/CSTAT]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins core_controller_0/S_AXI_ARSTN] [get_bd_pins hlangpu_0/ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins core_controller_0/S_AXI_ACLK] [get_bd_pins hlangpu_0/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins core_controller_0/CCLK] [get_bd_pins hlangpu_0/CCLK] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs core_controller_0/S_AXI/S_AXI_reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/HlangPU.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
